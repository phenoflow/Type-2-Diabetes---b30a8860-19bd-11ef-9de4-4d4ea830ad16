...
codes = [{"code":"9OLG.00","system":"readv2"},{"code":"9NiD.00","system":"readv2"},{"code":"9OLB.00","system":"readv2"},{"code":"9N4I.00","system":"readv2"},{"code":"9NiE.00","system":"readv2"},{"code":"9NiA.00","system":"readv2"},{"code":"9N4p.00","system":"readv2"}];
REQUIRED_CODES = 1;
